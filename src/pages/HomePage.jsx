      ...
      <section className="bg-gradient-to-br from-[#2B59C3] to-[#1e4a9f] text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Connect Students with Teachers</h1>
            <p className="text-xl md:text-2xl mb-8 text-blue-100">
              Streamline appointment booking and enhance educational communication
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/register">
                <Button size="lg" className="bg-white text-[#2B59C3] hover:bg-gray-100 px-8 py-3">
                  Get Started
                </Button>
              </Link>
            </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><Link to="/aboutus" className="hover:text-white">AboutUs</Link></li>
