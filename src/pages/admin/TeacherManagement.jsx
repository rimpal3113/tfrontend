 ...
 useEffect(() => {
  const fetchTeachers = async () => {
    ...
    try {
      ...
      const res = await fetch("https://stu-teacher-1.onrender.com/api/teachers", {
        headers: {
  ...
  const handleStatusChange = async (teacherId, newStatus) => {
    try {
      const res = await fetch(`https://stu-teacher-1.onrender.com/api/admin/teachers/${teacherId}/status`, {
        method: "PATCH",
