  ...
  useEffect(() => {
    const fetchTeacher = async () => {
      ...
      try {
        ...
        const res = await fetch(`https://stu-teacher-1.onrender.com/api/teachers/profile/${teacherId}`, {
          headers: {
...
try {
  ...
  const res = await fetch("https://stu-teacher-1.onrender.com/api/appointments", {
  method: "POST",
  headers: {
     "Content-Type": "application/json",
    Authorization: `Bearer ${token}`,
